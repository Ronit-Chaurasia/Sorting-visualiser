...
let div_sizes = [];
let divs = [];
let baseColor = "#41128c linear-gradient(36deg, rgb(72, 23, 231) 4%, rgb(32, 31, 102) 95%)";
let endColor = "#1d1c96 linear-gradient(50deg, rgb(30, 149, 239) 21%, rgb(29, 58, 184) 91%)";

let algo_btns = document.querySelectorAll(".algos button");
console.log(algo_btns);
...
function generate_array(){
    ...
    for (var i = 0; i < arr_size; i++) {
        ...
        margin_size = 0.08;
        divs[i].style = `margin: 0% ${margin_size}%; background:${baseColor}; width: ${(100 / arr_size - 2 * margin_size)}%; height: ${div_sizes[i]}%;)`;
    }
}
